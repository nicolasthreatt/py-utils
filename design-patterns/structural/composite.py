'''
Composite
	- Maintains a tree data structure to represent part-whole relationship
	- Problem
		+ Recursive tree data structure
	- Useful Case
		+ In Django trying to create menu for website Menu > submenu > sub-submenu > ...
'''


class Component(object):  # Parent Class
    """Abstract class"""
